          ...
          {showAbout && (
            <div className="popup-overlay" onClick={closePopup}>
              <div className="popup" onClick={(e) => e.stopPropagation()}>
                ...
                <p>
                  Paletteify is a unique web application that combines the world
                  of music with color. By analyzing your Spotify top tracks, we
                  generate a color palette based on the album art of your
                  most-played songs. You can customize your palette by adjusting
                  the time frame from which data is being taken.
                </p>
                <p>
                  If you notice anything wrong or have suggestions, please reach
                  out to dhan6663@usc.edu
                </p>
          ...
          {showPrivacy && (
            <div className="popup-overlay" onClick={closePopup}>
              <div className="popup" onClick={(e) => e.stopPropagation()}>
                ...
                <p>
                  Paletteify collects data from your Spotify account for the
                  sole purpose of providing a personalized experience. By using
                  Paletteify, you agree to the use of your account username and
                  information about your top listened-to artists as stated by
                  this policy. We do not store or share your personal
                  information with third parties. If at any point you wish to
                  remove Paletteify's permissions to generate your graphic on
                  Spotify, you can do so{" "}
                  <a
