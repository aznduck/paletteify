...
console.log('Client ID Length:', process.env.CLIENT_ID ? process.env.CLIENT_ID.length : 'missing');
console.log('Client Secret Length:', process.env.CLIENT_SECRET ? process.env.CLIENT_SECRET.length : 'missing');
...
console.log('- Headers present:', Object.keys(authOptions.headers).join(', '));
